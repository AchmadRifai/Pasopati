...
private entity.Akun a;
    ...
    try {
        entity.Aset aset=new entity.Aset(kode.getText(), ket.getText(), tipe.getItemAt(tipe.getSelectedIndex()), Long.parseLong(""+init.getValue()));
        ...
        if(!a.isSesi())new akutansi.InitSaldo(d, a).setVisible(true);
